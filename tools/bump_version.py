...
badge.write_text(f'<svg xmlns="http://www.w3.org/2000/svg" width="{width}" height="26" role="img" aria-label="version: {version}"><rect x=".5" y=".5" width="{width-1}" height="25" rx="7" fill="#f8f5ee" stroke="#d8cfc1"/><path d="M62 1v24" stroke="#d8cfc1"/><g font-family="Verdana, sans-serif" font-size="11" text-anchor="middle"><text x="31" y="17" fill="#655e55">version</text><text x="{62+(width-62)/2}" y="17" fill="#8b3a3a">{version}</text></g></svg>\n')
